...
void NativeLedgerClient::GetTransactionReport(const ledger::ActivityMonth month, const uint32_t year, ledger::GetTransactionReportCallback callback) {
  [bridge_ getTransactionReport:month year:year callback:callback];
}
void NativeLedgerClient::GetContributionReport(const ledger::ActivityMonth month, const uint32_t year, ledger::GetContributionReportCallback callback) {
