...
private:
  ...
  void GetTransactionReport(const ledger::ActivityMonth month, const uint32_t year, ledger::GetTransactionReportCallback callback) override;
  void GetContributionReport(const ledger::ActivityMonth month, const uint32_t year, ledger::GetContributionReportCallback callback) override;
};
